package com.variables
{
	...
	public class AccessVars
	{
		...
		public var arrStat:ArrayCollection = new ArrayCollection([{label:"All PR/PO",type:-1},{label:"Open PR/PO",type:0},{label:"Fully Served",type:1},{label:"Partially Served",type:2},{label:"Cancelled",type:3}])
